...
def ODEnet154(num_classes=1000, pretrained='imagenet'):
    model = SENet(ODEBottleneck, [3, 8, 36, 3], groups=64, reduction=16,
...
def ODE_resnet50(num_classes=1000, pretrained='imagenet'):
    model = SENet(ODEResNetBottleneck, [3, 4, 6, 3], groups=1, reduction=16,
...
def ODE_resnet101(num_classes=1000, pretrained='imagenet'):
    model = SENet(ODEResNetBottleneck, [3, 4, 23, 3], groups=1, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
...
def ODE_resnet152(num_classes=1000, pretrained='imagenet'):
    model = SENet(ODEResNetBottleneck, [3, 8, 36, 3], groups=1, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
...
def ODE_resnext50_32x4d(num_classes=1000, pretrained='imagenet'):
    model = SENet(ODEResNeXtBottleneck, [3, 4, 6, 3], groups=32, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
...
def ODE_resnext101_32x4d(num_classes=1000, pretrained='imagenet'):
    model = SENet(ODEResNeXtBottleneck, [3, 4, 23, 3], groups=32, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
