...
class ODENet03029(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        num_classes (int): Number of outputs in `last_linear` layer.
            - For all models: 1000
        """
        super(ODENet03029, self).__init__()
...
#         features4 = self.conv4_ode(x)
    ...
    def train(self, mode=True):
        super(ODENet03029, self).train(mode)
        self._freeze_stages()
...
def ODEnet154(num_classes=1000, pretrained='imagenet'):
    model = ODENet03029(ODEBottleneck, [3, 8, 36, 3], groups=64, reduction=16,
...
def ODE_resnet50(num_classes=1000, pretrained='imagenet'):
    model = ODENet03029(ODEResNetBottleneck, [3, 4, 6, 3], groups=1, reduction=16,
...
def ODE_resnet101(num_classes=1000, pretrained='none'):
    model = ODENet03029(ODEResNetBottleneck, [3, 4, 23, 3], groups=1, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
...
def ODE_resnet152(num_classes=1000, pretrained='imagenet'):
    model = ODENet03029(ODEResNetBottleneck, [3, 8, 36, 3], groups=1, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
...
def ODE_resnext50_32x4d(num_classes=1000, pretrained='imagenet'):
    model = ODENet03029(ODEResNeXtBottleneck, [3, 4, 6, 3], groups=32, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
...
def ODE_resnext101_32x4d(num_classes=1000, pretrained='imagenet'):
    model = ODENet03029(ODEResNeXtBottleneck, [3, 4, 23, 3], groups=32, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  num_classes=num_classes)
    if pretrained is not None:
